...
export const FEATURE_KEYS = {
  ...
  INCIDENT_ANALYTICS: "incidents.analytics.enabled",

  SAFETY_CONCERN_PROFILES: "safety_concerns.profiles.enabled",
  SAFETY_CONCERN_PHOTO_LIMIT: "safety_concerns.photos.max_per_profile",
  SAFETY_CONCERN_PHOTO_SIZE_MB: "safety_concerns.photos.max_size_mb",
  SAFETY_CONCERN_PROFILE_LIMIT: "safety_concerns.profiles.max_active",
...
export const FEATURE_DISPLAY_NAMES: Record<FeatureKey, string> = {
  ...
  [FEATURE_KEYS.INCIDENT_ANALYTICS]: "Incident analytics",
  [FEATURE_KEYS.SAFETY_CONCERN_PROFILES]: "Known Safety Concerns",
  [FEATURE_KEYS.SAFETY_CONCERN_PHOTO_LIMIT]: "Photos per safety profile",
  [FEATURE_KEYS.SAFETY_CONCERN_PHOTO_SIZE_MB]: "Safety concern photo size",
  [FEATURE_KEYS.SAFETY_CONCERN_PROFILE_LIMIT]: "Active safety concern profiles",
