...
export function labelForNotificationType(type: string): string {
  const labels: Record<string, string> = {
    ...
    "safety_concern.review_due": "Safety concern review due",
    "safety_concern.review_overdue": "Safety concern review overdue",
    "safety_concern.expired": "Safety concern profile expired",
