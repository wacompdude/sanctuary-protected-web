...
export const BOOLEAN_FEATURE_KEYS: readonly FeatureKey[] = [
  ...
  FEATURE_KEYS.INCIDENT_ANALYTICS,
...
export const INTEGER_FEATURE_KEYS: readonly FeatureKey[] = [
  ...
  FEATURE_KEYS.SAFETY_CONCERN_PHOTO_LIMIT,
  FEATURE_KEYS.SAFETY_CONCERN_PHOTO_SIZE_MB,
  FEATURE_KEYS.SAFETY_CONCERN_PROFILE_LIMIT,
