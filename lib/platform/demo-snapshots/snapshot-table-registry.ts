...
export const SNAPSHOT_TABLE_REGISTRY: SnapshotTableDefinition[] = [
  ...
  {
    tableName: "organization_billing_profiles",
    organizationScopeColumn: "organization_id",
    dependencyOrder: 902,
    restoreStrategy: "exclude",
    containsStorageReferences: false,
    sensitive: true,
    required: false,
    notes: "Provider customer IDs and complimentary flags; never snapshot live Stripe data.",
  },
  {
  ...
  {
    tableName: "organization_sms_credit_balances",
    organizationScopeColumn: "organization_id",
    dependencyOrder: 905,
    restoreStrategy: "exclude",
    containsStorageReferences: false,
  ...
  {
    tableName: "organization_sms_credit_ledger",
    organizationScopeColumn: "organization_id",
    dependencyOrder: 906,
    restoreStrategy: "exclude",
    containsStorageReferences: false,
