-- =============================================================================
-- DRAFT — DO NOT APPLY until Phase 2 is approved and Phase 3 begins.
-- File: supabase/migrations/draft/080_demo_organization_snapshots.sql
--
-- Demo Organization Snapshot / Restore foundation:
...
--   - private storage bucket registration (metadata; create bucket in dashboard
--     or via storage API in Phase 3)
-- =============================================================================
...
-- Extend category enum (idempotent)
DO $$ BEGIN
  ALTER TYPE public.platform_permission_category ADD VALUE IF NOT EXISTS 'demo_environments';
EXCEPTION
...
-- =============================================================================
-- MANUAL / Phase 3 follow-ups (not in this SQL):
-- 1. Create private Storage bucket: demo-organization-snapshots
-- 2. Mark First Church:
...
-- 3. Seed demo_protected_accounts from known demo Auth user ids
-- 4. If ALTER TYPE ... ADD VALUE IF NOT EXISTS unsupported, add value in a
--    separate transaction before seeding permissions.
-- =============================================================================
